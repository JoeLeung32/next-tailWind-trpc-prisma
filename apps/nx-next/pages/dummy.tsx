...
export async function getServerSideProps() {
    ...
    const apiURL = `${process.env.STRAPI_API_URL}${apiPath}`
...
export function Index(props: any) {
    ...
    const Content = () => (
        <div className={`mb-12 border-gray-500 border rounded-md p-2 px-4`}>
            ...
            <p>
                1. <strong>Hosting on Railway.app:</strong> Strapi + PostgreSQL;
            </p>
            <p>
                2. <strong>Hosting on Vercel:</strong> Next.js + tailwindcss +
                tRPC + Prisma ORM;
            </p>
            <p>
                3. <strong>Hosting on Supabase:</strong> PostgreSQL (for Next.js
                use)
            </p>
            <p>
                4. <strong>Hosting on Amazon:</strong> S3 (for Strapi use)
            </p>
        </div>
    )
    ...
    return (
        <div className={styles.page}>
            <Content />
            <h1 className={`font-bold text-3xl mb-2`}>tRPC + Prisma</h1>
            {/*---*/}
            <dl className={`mb-5`}>
            ...
            <dl className={`mb-5`}>
                <dt className={`font-bold`}>
                    tRPC call - external (Create Data)
                </dt>
                <dd>
                    <form
                        onSubmit={async (e) => {
            ...
            {/*---*/}
            <h1 className={`font-bold text-3xl mb-2 mt-12`}>Strapi</h1>
            <hr />
            <p>Total: {total}</p>
            {list && list.length ? (
                list.map(
